    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalc.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                parametros.putString("edtData2",txtData.getText().toString());

                parametros.putString("edtLote",edtLote.getText().toString());//tenho que por o txtData
                ...
                parametros.putString("tipoSpinner",item);


                
                

                parametros.putString("edtIngred",edtIngred.getText().toString());

                parametros.putString("edtIngred1",edtIngred1.getText().toString());

                parametros.putString("edtIngred2",edtIngred2.getText().toString());

                parametros.putString("edtIngred3",edtIngred3.getText().toString());

                parametros.putString("edtIngred4",edtIngred4.getText().toString());

                parametros.putString("edtIngred5",edtIngred5.getText().toString());

                parametros.putString("edtIngred6",edtIngred6.getText().toString());

                parametros.putString("edtIngred7",edtIngred7.getText().toString());

                parametros.putString("edtIngred8",edtIngred8.getText().toString());
                ...
                parametros.putString("edtQtd2",edtQtd2.getText().toString());

                parametros.putString("edtQtd3",edtQtd3.getText().toString());

                parametros.putString("edtQtd4",edtQtd4.getText().toString());

                parametros.putString("edtQtd5",edtQtd5.getText().toString());

                parametros.putString("edtQtd6",edtQtd6.getText().toString());

                parametros.putString("edtQtd7",edtQtd7.getText().toString());

                parametros.putString("edtQtd8",edtQtd8.getText().toString());

                parametros.putString("edtQtd9",edtQtd9.getText().toString());
